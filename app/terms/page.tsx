        ...
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              By accessing and using AutoDoc AI, you agree to be bound by these Terms of Service
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              AutoDoc AI grants you a limited, non-exclusive, non-transferable license to use
              our service for generating documentation for your code.
            </p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight">3. Service Availability</h2>
            <p className="text-muted-foreground">
              We strive to maintain high availability but do not guarantee uninterrupted access
              to the service. We reserve the right to modify or discontinue the service at any time.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              AutoDoc AI is provided "as is" without warranties of any kind. We are not liable
              for any damages arising from your use of the service.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight">5. Changes to Terms</h2>
            <p className="text-muted-foreground">
