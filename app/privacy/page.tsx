      ...
      <main className="flex-1 container py-12">
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">When you use AutoDoc AI, we collect:</p>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              We take security seriously. Your code is processed securely and is not stored permanently.
              All uploaded code is automatically deleted after processing is complete.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              ...
              <a href="mailto:privacy@autodoc-ai.com" className="text-primary hover:underline">
